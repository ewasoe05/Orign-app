...
export const ESSENTIALS_PER_CHECK = 943.5;
export const EXTRA_TARGET_PER_CHECK = 1000;
export const EMERGENCY_FUND_TARGET = 6000;
export const MILESTONE_MID_PERCENT = 61;
export const MILESTONE_NEAR_PERCENT = 84;
export const DEFAULT_FUN_PERCENT = 0;
